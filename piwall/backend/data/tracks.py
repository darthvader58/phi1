...
TRACKS: Dict[str, TrackConfig] = {
    "bahrain": TrackConfig(
        ...
        drs_zones=3,
        base_lap_time=92.0,
        safety_car_prob_dry=0.07,
        safety_car_prob_wet=0.15,
    ...
    "monaco": TrackConfig(
        ...
        drs_zones=1,
        base_lap_time=73.0,
        safety_car_prob_dry=0.12,
        safety_car_prob_wet=0.22,
    ...
    "monza": TrackConfig(
        ...
        drs_zones=2,
        base_lap_time=81.0,
        safety_car_prob_dry=0.06,
        safety_car_prob_wet=0.14,
    ...
    "spa": TrackConfig(
        ...
        drs_zones=2,
        base_lap_time=106.0,
        safety_car_prob_dry=0.09,
        safety_car_prob_wet=0.18,
        overtake_difficulty=0.3,
        fuel_load_kg=110.0,
        weather_transitions={
    ...
    "suzuka": TrackConfig(
        ...
        drs_zones=1,
        base_lap_time=91.0,
        safety_car_prob_dry=0.08,
        safety_car_prob_wet=0.17,
