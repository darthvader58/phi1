...
TRACKS: Dict[str, TrackConfig] = {
    ...
    "monaco": TrackConfig(
        ...
        fuel_load_kg=110.0,
        # Monaco = Mediterranean, occasional rain
        weather_transitions={
            "dry": {"dry": 0.96, "damp": 0.035, "wet": 0.005},
            "damp": {"dry": 0.30, "damp": 0.50, "wet": 0.20},
            "wet": {"dry": 0.05, "damp": 0.25, "wet": 0.70},
            "drying": {"dry": 0.40, "damp": 0.42, "wet": 0.03, "drying": 0.15},
        },
    ...
    "monza": TrackConfig(
        ...
        fuel_load_kg=110.0,
        # Monza = northern Italy, moderate rain chance
        weather_transitions={
            "dry": {"dry": 0.96, "damp": 0.03, "wet": 0.01},
            "damp": {"dry": 0.30, "damp": 0.50, "wet": 0.20},
            "wet": {"dry": 0.05, "damp": 0.25, "wet": 0.70},
            "drying": {"dry": 0.38, "damp": 0.44, "wet": 0.03, "drying": 0.15},
        },
    ...
    "spa": TrackConfig(
        ...
        overtake_difficulty=0.3,
        fuel_load_kg=110.0,
        # Spa = famously unpredictable, most rain-prone track
        weather_transitions={
            "dry": {"dry": 0.93, "damp": 0.05, "wet": 0.02},
            "damp": {"dry": 0.20, "damp": 0.55, "wet": 0.25},
            "wet": {"dry": 0.03, "damp": 0.22, "wet": 0.75},
            "drying": {"dry": 0.30, "damp": 0.48, "wet": 0.05, "drying": 0.17},
        },
    ...
    "silverstone": TrackConfig(
        ...
        fuel_load_kg=110.0,
        # Silverstone = British weather, moderate rain
        weather_transitions={
            "dry": {"dry": 0.94, "damp": 0.045, "wet": 0.015},
            "damp": {"dry": 0.25, "damp": 0.52, "wet": 0.23},
            "wet": {"dry": 0.04, "damp": 0.24, "wet": 0.72},
    ...
    "suzuka": TrackConfig(
        ...
        fuel_load_kg=110.0,
        # Suzuka = typhoon season, moderate-high rain
        weather_transitions={
            "dry": {"dry": 0.94, "damp": 0.04, "wet": 0.02},
            "damp": {"dry": 0.22, "damp": 0.53, "wet": 0.25},
            "wet": {"dry": 0.03, "damp": 0.22, "wet": 0.75},
